...
def test_build_title_with_quota():
    assert build_title(69411491, 0.03, 78, 100, 100, 100) == '69.4M $0.03 · 78% · 100%'

def test_build_title_without_quota():
    assert build_title(0, 0, None, None, None, None) == '0 $0.00 · -- · --'
...
def test_title_zero_session_full_weekly():
    assert build_title(0, 0, 0, 100, 100, 100) == '0 $0.00 · 0% · 100%'
